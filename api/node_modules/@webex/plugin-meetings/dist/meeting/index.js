  ...
  (0, _createClass2.default)(Meeting, [{
    ...
    value: function setUpLocusInfoMediaInactiveListener() {
      ...
      this.locusInfo.on(_constants.EVENTS.DISCONNECT_DUE_TO_INACTIVITY, function (res) {
        ...
        }, _constants.EVENTS.REQUEST_UPLOAD_LOGS, _this2); // TODO: need to send metric for locus disconnect
    ...
    value: function setUpLocusMediaSharesListener() {
      ...
      this.locusInfo.on(_constants.EVENTS.LOCUS_INFO_UPDATE_MEDIA_SHARES, function (payload) {
        ...
        var newShareStatus = _this9.shareStatus; // check if remote started sharing
            ...
            case _constants.SHARE_STATUS.REMOTE_SHARE_ACTIVE:
              {
                ...
                if ((_this9$mediaPropertie = _this9.mediaProperties.mediaDirection) !== null && _this9$mediaPropertie !== void 0 && _this9$mediaPropertie.sendShare) {
                  _this9.updateShare({
                    sendShare: false,
    ...
    value: function setUpLocusInfoSelfListener() {
      ...
      this.locusInfo.on(_constants.LOCUSINFO.EVENTS.MEDIA_STATUS_CHANGE, function (status) {
        if (_this12.statsAnalyzer) {
          var _this12$mediaProperti, _this12$audio, _this12$mediaProperti2, _this12$video, _this12$mediaProperti3, _this12$mediaProperti4, _this12$mediaProperti5, _this12$mediaProperti6;

          _this12.statsAnalyzer.updateMediaStatus({
            actual: status,
            expected: {
              // We need to check what should be the actual direction of media
              sendAudio: ((_this12$mediaProperti = _this12.mediaProperties.mediaDirection) === null || _this12$mediaProperti === void 0 ? void 0 : _this12$mediaProperti.sendAudio) && !((_this12$audio = _this12.audio) !== null && _this12$audio !== void 0 && _this12$audio.isMuted()),
    ...
    value: function updateAudio(options) {
      ...
      return _util.default.validateOptions({
        ...
        _this34.audio = _this34.audio || _audio.default.create(_this34.mediaProperties.mediaDirection, _this34);
      });
    }
    /**
    ...
    value: function updateVideo(options) {
      ...
      return _util.default.validateOptions({
        ...
        _this35.video = _this35.video || _video.default.create(_this35.mediaProperties.mediaDirection, _this35);
      });
    }
    /**
