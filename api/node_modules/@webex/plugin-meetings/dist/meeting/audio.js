...
var doToggle = function doToggle(transition, audio, meeting) {
  ...
  return _util.default.remoteUpdateAudioVideo(audio.mute, videoMuted, meeting).then(function (locus) {
      ...
      methods: {
        ...
        onBeforeToggle: function onBeforeToggle(transition, audio) {
          ...
          if (transition.from !== transition.to) {
            return doToggle(transition, audio, meeting).then(function (locus) {
              _this.setData(audio);
