...
var Meetings = /*#__PURE__*/function (_WebexPlugin) {
  ...
  function Meetings() {
    ...
    _util.default.checkH264Support({
  ...
  (0, _createClass2.default)(Meetings, [{
    ...
    value: function register() {
      ...
      }), _util.default.checkH264Support.call(this)]).then(function () {
    ...
    value: function syncMeetings() {
      ...
      return this.request.getActiveMeetings().then(function (locusArray) {
        ...
        if ((0, _keys.default)(_this10.meetingCollection.getAll()).length > 0) {
          // Some time the mercury event is missed after mercury reconnect
          // if sync returns no locus then clear all the meetings
          (0, _forEach2.default)(_this10.meetingCollection.getAll(), function (meeting) {
            if (!activeLocusUrl.includes(meeting.locusUrl)) {
              if (_this10.config.autoUploadLogs) {
                var _meeting$locusInfo, _meeting$locusInfo$fu, _meeting$locusInfo2, _meeting$locusInfo2$i;
                ...
                _this10.uploadLogs({
                  ...
                  meetingId: (_meeting$locusInfo2 = meeting.locusInfo) === null || _meeting$locusInfo2 === void 0 ? void 0 : (_meeting$locusInfo2$i = _meeting$locusInfo2.info) === null || _meeting$locusInfo2$i === void 0 ? void 0 : _meeting$locusInfo2$i.webExMeetingId
                }).then(function () {
                  return _this10.destroy(meeting, _constants.MEETING_REMOVED_REASON.NO_MEETINGS_TO_SYNC);
                });
              } else {
